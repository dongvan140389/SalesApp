...
import com.example.dongvan.SalesApp.UIView.HienThiSanPhamTheoDanhMuc.HienThiSanPhamTheoDanhMucActivity;
...
public class ThuongHieuLonAdapter extends  RecyclerView.Adapter<ThuongHieuLonAdapter.ViewHolderThuongHieu> {
    ...
    public ThuongHieuLonAdapter(Context context, List<ThuongHieu> thuongHieus,boolean kiemtra){
    ...
    public void onBindViewHolder(final ViewHolderThuongHieu holder, int position) {
        ...
        //Picasso.with(context).load(thuongHieu.getHINHTHUONGHIEU()).resize(120,120).into(holder.imHinhThuongHieu);
        //Log.d("hinh TH: ", thuongHieu.getHINHTHUONGHIEU());
