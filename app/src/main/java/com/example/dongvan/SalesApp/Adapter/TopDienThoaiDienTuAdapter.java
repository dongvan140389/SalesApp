...
import com.example.dongvan.SalesApp.UIView.ChiTietSanPham.ChiTietSanPhamActivity;
...
public class TopDienThoaiDienTuAdapter extends RecyclerView.Adapter<TopDienThoaiDienTuAdapter.ViewHolderTopDienThoai>{
    Context context;
