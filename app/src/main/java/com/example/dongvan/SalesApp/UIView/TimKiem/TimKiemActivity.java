package com.example.dongvan.SalesApp.UIView.TimKiem;
...
import com.example.dongvan.SalesApp.Presenter.TrangChu.XuLyMenu.TimKiem.PresenterLogicTimKiem;
...
public class TimKiemActivity extends AppCompatActivity implements ViewTimKiem, ILoadMore, SearchView.OnQueryTextListener {
    ...
    public void TimKiemThanhCong(List<SanPham> sanPhamList) {
        ...
        TopDienThoaiDienTuAdapter adapterTopDienThoaiDienTu = new TopDienThoaiDienTuAdapter(this,R.layout.custom_layout_list_topdienthoaivamaytinhbang,sanPhamList);
