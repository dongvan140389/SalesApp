...
import com.example.dongvan.SalesApp.Adapter.AdapterViewPagerSlider;
import com.example.dongvan.SalesApp.Adapter.DanhGiaAdapter;
import com.example.dongvan.SalesApp.Model.ObjectClass.ChiTietKhuyenMai;
import com.example.dongvan.SalesApp.Model.ObjectClass.ChiTietSanPham;
...
import com.example.dongvan.SalesApp.Presenter.TrangChu.XuLyMenu.ChiTietSanPham.FragmentSliderChiTietSanPham;
...
import com.example.dongvan.SalesApp.UIView.DanhGia.DanhGiaActivity;
import com.example.dongvan.SalesApp.UIView.DanhGia.DanhSachDanhGiaActivity;
...
public class ChiTietSanPhamActivity extends AppCompatActivity implements ViewChiTietSanPham, ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    ViewPager viewPager;
    PresenterChiTietSanPham presenterLogicChiTietSanPham;
    TextView[] txtDots;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenterLogicChiTietSanPham = new PresenterChiTietSanPham(this);
    ...
    private void HienThiThongSoKyThuat(SanPham sanPham){
        ...
        txtTieuDeThongSoKyThuat.setText("Thông số ký thuật");
